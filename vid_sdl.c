...
//#define    BASEWIDTH    (320*2 ) // 640 
				 // by
//#define    BASEHEIGHT   (240*2 ) // 480
// TDA replaced end
...
cvar_t	axis_x_function =	{"xbox_axisx_function", "2", true};
cvar_t	axis_y_function =	{"xbox_axisy_function", "3", true};
...
cvar_t	axis_y2_function =	{"xbox_axisy2_function", "2", true};
...
cvar_t	axis_pitch_dz =		{"xbox_pitch_threshold", "0.15", true};
cvar_t	axis_yaw_dz =		{"xbox_yaw_threshold", "0.15", true};
cvar_t	axis_walk_dz =		{"xbox_walk_threshold", "0.15", true};
cvar_t	axis_strafe_dz =	{"xbox_strafe_threshold", "0.15", true};
...
void IN_Init (void)
{
	...
	SDL_JoystickEventState(SDL_ENABLE);
    sdl_joysticks = SDL_JoystickOpen(0);
}
